...
architecture Behavioral of serpent_core is
    ...
    type fsm_state_t is (IDLE, KEY_EXP, RUNNING, FINISHED);
        ...
        if reset = '1' then
            ...
            case fsm is
                ...
                when RUNNING =>
                    ...
                    -- ejecuta una ronda de Serpent
                    state_reg <= next_state;

                    if step_cnt = 31 then

                        -- se ha completado la ronda 31
                        fsm <= FINISHED;
